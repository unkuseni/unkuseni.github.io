...
const Hero = () => {
	return (
		<>
			<div
				className={`relative flex flex-col justify-between flex-nowrap min-h-[100vh] transition-opacity duration-500 bg-hero-pattern p-12 py-24 overflow-hidden bg-cover bg-center bg-no-repeat`}
			>
