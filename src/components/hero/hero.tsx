const Hero = () => {
  return (
    <div className="md:snap-start w-screen overflow-hidden flex-shrink-0  min-h-[calc(100vh-73px)]">
      <div className="relative flex flex-col justify-between flex-nowrap md:min-w-[100vw] min-h-[calc(100vh-73px)] transition-opacity duration-500 p-12 py-24 overflow-hidden">
        <h1 className="text-[clamp(4rem,6vw,7rem)] uppercase font-bold animate-slide-down duration-700 md:text-center">
        ...
        <img
          src="/port.jpeg"
          alt="Adeoye Olaseni working on a software development project"
          className="w-3/5 h-auto absolute right-0 sm:right-10 bottom-0 max-w-4xl"
        />
        ...
        <div className="absolute bottom-0 left-0 p-3 uppercase max-sm:hidden">
          <p className="flex items-center gap-2">
            ...
            <span className="inline-block border rounded-full text-center w-8 h-8 transform -rotate-90">
        ...
        <div className="absolute bottom-0 right-0 p-3 uppercase sm:hidden">
          <p className="flex items-center gap-2">
            ...
            <span className="inline-block border rounded-full text-center w-8 h-8">
              <span className="animate-bounce p-2">↓</span>
            </span>
          </p>
        </div>
