      ...
      <article className="p-6 mt-28">
        ...
        <p className="mt-10 leading-10 text-2xl">
          ...
          <span className="font-playfair italic">
            Unveiling the secrets of atoms and molecules has always inspired me.
          </span>
          <br />
          Just as reactions transform substances, I apply scientific principles
          to innovate and solve complex problems.
          <br />
          Merging my expertise in chemistry with software development, I strive
          to create solutions that advance both science and technology."
        </p>
