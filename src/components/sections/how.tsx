  ...
  return (
    ...
    >
      ...
      <article className="p-6 md:w-[576px] md:flex md:flex-col md:items-center md:justify-center md:flex-shrink-0 md:h-[600px] md:relative md:self-center md:gap-5">
        <h2 className="text-xl font-bold uppercase">precision in every step</h2>
        <p className="font-editorial text-2xl mt-5 leading-10">
          ...
          think smooth animations and snappy performance. And here's the deal:
          I'm 100% committed to working closely with you. Your input is gold,
          and I'm always ready to tweak and adjust until we nail it. Let's make
      ...
      <article className="p-6 md:w-[576px] md:flex md:flex-col md:items-center md:justify-center md:flex-shrink-0 md:h-[600px] md:relative md:self-start md:gap-5">
        ...
        <p className="font-editorial text-2xl mt-5 leading-10">
          ...
          software project. We work together to identify your goals, challenges,
          and preferences. As we build your solution, I continuously test and
          refine it to ensure it meets your expectations. Whether it's improving
          your business operations or creating a better user experience, I'm
          committed to delivering a high-quality solution that works the way you
          need it to.
        </p>
        <h2 className="text-xl font-bold uppercase mt-5">my tech stack</h2>
        <p className="font-editorial text-2xl mt-5 leading-10">
          For smaller projects, I prefer working with vanilla JavaScript, which
          allows me to craft a tailored architecture that precisely matches each
          project's requirements. I complement this with powerful animation
          libraries like GSAP for fluid motion effects and Three.js for
          immersive 3D web experiences. When tackling larger projects, I utilize
          frameworks like Astro or Next.js to ensure optimal scalability and
          performance.
        </p>
      </article>
